...
// Logistics nodes for "SUV 4x4 Armoured (AAF)" (UK3CB_C_SUV_Armoured_AAF)
// Generated by ACNE, the Antistasi Cargo Nodes Editor
class UK3CB_Factions_addons_UK3CB_Factions_Vehicles_wheeled_UK3CB_Factions_Vehicles_suv_uk3cb_suv_armoured_p3d : TRIPLES(ADDON,Nodes,Base)
{
    class Nodes
    {
        class Node1
        {
            offset[] = {-0.06068,-1.4,0.25513};
            seats[] = {};
        };

        class Node2
        {
            offset[] = {-0.0616401,-2,0.25501};
            seats[] = {};
        };
    };
};
